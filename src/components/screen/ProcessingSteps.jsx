  ...
  return (
    <section>
      <div className="container mt-16 lg:mt-20 pb-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 items-center w-full lg:w-5/6 mx-auto">
          {steps.map((step, index) => (
            <div key={index} className={`bg-primary-50/30 lg:bg-white rounded p-3 lg:p-0 block text-center lg:flex items-center lg:space-x-3 ${index !== steps.length - 1 && "lg:border-r"}`}>
