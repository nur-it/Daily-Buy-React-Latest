    ...
    return (
        <div className='lg:container flex flex-wrap justify-center lg:justify-between gap-8 md:gap-12 lg:gap-24 mt-[65px]'>
            <div className='cursor-pointer group text-center flex flex-col items-center justify-center'>
                ...
                <h2 className=' text-[12px] md:text-[16px] lg:text-[20px] mt-[24px] group-hover:underline duration-300 transition-all'>Fruits & Vegetable</h2>
            ...
            <div className=' cursor-pointer group text-center flex flex-col items-center justify-center'>
                ...
                <h2 className=' text-[12px] md:text-[16px] lg:text-[20px] mt-[24px]  group-hover:underline duration-300 transition-all'>Meats & Fish</h2>
                <p className=' text-[10px] md:text-[12px] lg:text-[16px] text-gray-500  group-hover:underline duration-300 transition-all'>6 Items</p>
            </div>
            <div className=' cursor-pointer group text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                ...
                <h2 className=' text-[12px] md:text-[16px] lg:text-[20px] mt-[24px]  group-hover:underline duration-300 transition-all'>Breads & Bakery</h2>
                <p className=' text-[10px] md:text-[12px] lg:text-[16px] text-gray-500  group-hover:underline duration-300 transition-all'>6 Items</p>
            </div>
            <div className=' cursor-pointer group text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                ...
                <h2 className=' text-[12px] md:text-[16px] lg:text-[20px] mt-[24px]  group-hover:underline duration-300 transition-all'>Breakfast & Dairy</h2>
                <p className=' text-[10px] md:text-[12px] lg:text-[16px] text-gray-500  group-hover:underline duration-300 transition-all'>6 Items</p>
            </div>
            <div className=' cursor-pointer group text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                ...
                <h2 className=' text-[12px] md:text-[16px] lg:text-[20px] mt-[24px]  group-hover:underline duration-300 transition-all'>Frozen Foods</h2>
                <p className=' text-[10px] md:text-[12px] lg:text-[16px] text-gray-500  group-hover:underline duration-300 transition-all'>6 Items</p>
            </div>
        </div>
    );
